*****************************************************************************************************************
Documentation :
  TensorFlow for A64FX (2020/11/30)
*****************************************************************************************************************
...
2. Preparation
  ...
  2-2. Environment Setting
      ...
      Modify the following environment variables in "env.src".
          ...
          ################################################
          export PREFIX=/home/fukushi/dev/30_upstream/tensorflow_env/setup/tensorflow/fcc_build_script
          export TCSDS_PATH=/opt/FJSVstclanga/v1.1.0
          export INSTALL_PATH=/home/fukushi/dev/30_upstream/01_work
          ```
